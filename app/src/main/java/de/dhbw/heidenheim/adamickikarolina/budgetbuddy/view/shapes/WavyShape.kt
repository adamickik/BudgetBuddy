package de.dhbw.heidenheim.adamickikarolina.budgetbuddy.view.shapes
...
class WavyShape(
    ...
    override fun createOutline(
        ...
        val wavyPath = Path().apply {
            ...
            moveTo(x = -halfPeriod / 2, y = size.height-amplitude)
        ...
        op(wavyPath, boundsPath, PathOperation.ReverseDifference)
    })
}