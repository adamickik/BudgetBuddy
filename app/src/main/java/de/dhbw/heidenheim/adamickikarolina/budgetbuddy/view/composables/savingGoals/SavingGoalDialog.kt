        ...
        AlertDialog(
            ...
            title = {
                Text(
                    text= if (editingSavingGoal!= null)
                        stringResource(id = R.string.savingGoalDialog_edit_name)
                    else
                        stringResource(id = R.string.savingGoalDialog_name)
                )},
            text = {
                Column {
                    CustomOutlinedTextField(
                        ...
                        label = stringResource(id = R.string.savingGoalDialog_title),
                    ...
                    Row(
                        ...
                        OutlinedTextField(
                            ...
                            onValueChange = {},
                            label = { Text(stringResource(id = R.string.savingGoalDialog_dueDate)) },
                            readOnly = true,
                            singleLine = true,
                        ...
                        )
                        {
                            IconButton(
                                ...
                                Icon(
                                    ...
                                    contentDescription = stringResource(id = R.string.savingGoalDialog_button_dueDate)
                                )
                            }
                        }
                    }
            ...
            confirmButton = {
                Button(
                    ...
                    Text(
                        text = if (editingSavingGoal != null)
                            stringResource(id = R.string.savingGoalDialog_button_edit)
                        else
                            stringResource(id = R.string.savingGoalDialog_button_add)
                    )
                }
                if(editingSavingGoal!=null){
                    Button(
            ...
            dismissButton = {
                Button(onClick = { onDismiss() }) {
                    Text(stringResource(id = R.string.savingGoalDialog_button_dismiss))
                }
            }
        )
    }
